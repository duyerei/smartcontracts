...
export function PartnerDetail() {
  ...
  const descriptionPlaceholder = '可补充录入合作背景、沟通要点、特殊约定或其它说明'
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <Card>
            <CardHeader><CardTitle>描述说明</CardTitle></CardHeader>
            <CardContent>
              {isEditing ? (
                <textarea
                  className="w-full border rounded-md px-3 py-2 text-sm min-h-[140px] resize-y focus:outline-none focus:ring-2 focus:ring-ring"
                  value={form.notes || ''}
                  onChange={e => setForm(f => ({ ...f, notes: e.target.value }))}
                  placeholder={descriptionPlaceholder}
                />
                ...
                <p className="text-sm text-muted-foreground">暂无补充说明</p>
              )}
            </CardContent>
          </Card>
