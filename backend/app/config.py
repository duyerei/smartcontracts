...
class Config:
    ...
    # 钉钉扫码登录
    DINGTALK_LOGIN_ENABLED = os.getenv("DINGTALK_LOGIN_ENABLED", "false").lower() == "true"
    DINGTALK_LOGIN_CLIENT_ID = os.getenv("DINGTALK_LOGIN_CLIENT_ID", os.getenv("DINGTALK_APP_KEY", ""))
    DINGTALK_LOGIN_CLIENT_SECRET = os.getenv("DINGTALK_LOGIN_CLIENT_SECRET", os.getenv("DINGTALK_APP_SECRET", ""))
    DINGTALK_LOGIN_REDIRECT_URI = os.getenv("DINGTALK_LOGIN_REDIRECT_URI", "")
    DINGTALK_LOGIN_CORP_ID = os.getenv("DINGTALK_LOGIN_CORP_ID", "")
